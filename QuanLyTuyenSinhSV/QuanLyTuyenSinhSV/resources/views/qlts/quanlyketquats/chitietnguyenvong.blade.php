...
@section('content')
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Chi tiết nguyện vọng
                ...
                @endif
                 ...
                 {{-- tim kiem --}}
                 <form id="search-form" action="qlts/quanlyketquats/timkiemctnv" method="GET">
                    <table style="margin:auto;">
                        <tr>

                            <td><p style="margin-left:70px;">Mã hồ sơ:</p></td>
                            <td><input name="mahoso"></td>
                            <td><p style="margin-left:70px;">Họ tên:</p></td>
                ...
                <form action="{{route('exportctnv')}}" method="POST">
                    @csrf
                    <table>
                        <tr>
                            <td><p  style="margin-left:70px;">Phương thức xét tuyển:</p></td>
                ...
                <form action="{{route('exportctnvtheonganh')}}" method="POST">
                    @csrf
                    <table>
                        <tr>
